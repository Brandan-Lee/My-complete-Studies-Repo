...
namespace BLL
{
    public class General
    {
        public static class ProcessType 
        {
            ...
            public static int IconFavLogoAdd = 11;
            public static int IconFavLogoUpdate = 12;
            public static int IconFavLogoDelete = 13;
            public static int MetaAdd = 14;
            public static int MetaUpdate = 15;
            public static int MetaDelete = 16;
            public static int SocialMediaAdd = 17;
            public static int SocialMediaUpdate = 18;
            public static int SocialMediaDelete = 19;
