...
#  two - that is, whichever has the more characters. If the strings are of equal length, the program should
#  print out "The strings are equally long".

# Write your solution here
#create interface
string1 = input("Please type in string 1: ")
string2 = input("Please type in string 2: ")
#check which string is the longest, else print that the strings are equal length
