...
public class CyclingStatistics {
    ...
    public List<String> locations() {
        ...
        List<String> locations = Arrays.stream(rows.get(0).split(";"))
    ...
    public Map<String, Integer> monthlyCyclists(String location) {
        ...
        rows.stream()
                ...
                .forEach(array -> {
                    ...
                    String month = dateArray[3] + " / "
                            + stringToMonthNumber(dateArray[2]);
        ...
        monthlyValues.keySet().stream()
                .forEach(value -> {
                    cyclistCounts.put(value, monthlyValues.get(value).stream()
                            .mapToInt(a -> a).sum());
                });
